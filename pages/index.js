  ...
  return (
    <>
      ...
      <projects id="projects">
        ...
        <BlogItem title="WADaily Mobile" link="https://github.com/willv678/WADaily-Mobile" color = "#D8575C" description="A React-Native mobile app designed for WADaily, an all-in-one school assistant that displays class schedules, lunch menus, events, and more on the go!" imgLink = "/images/wadailymobilebanner.png"/>
      </projects>
    </>
  )
}
